    ...
    render(): ReactNode {
        ...
        return (
            <>
                <Fieldset>
                    ...
                    >
                        {formFields.map((field) => {
                            ...
                            return (
                                <DynamicFormField
                                    autocomplete={field.custom ? 'off' : AUTOCOMPLETE[field.name]}
                ...
                <div className="department-lookup-container">
                    <h3 className="department-lookup-header">Don't know your department code? Click the button below!</h3>
                    <div className="department-lookup-button">
                        <a
